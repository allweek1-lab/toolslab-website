    ...
    >
      ...
      <PolicySection title="1. 처리하는 정보와 이용 목적">
        <ul>
          ...
          <li><strong>푸시 알림:</strong> 사용자가 알림을 직접 켠 경우에만 Expo 푸시 토큰, 기기 플랫폼과 알림 설정을 알림 전송에 사용합니다.</li>
          ...
          <li><strong>공개 Threads 콘텐츠:</strong> 공식 Threads API로 제공되는 공개 게시물의 작성자 표시명, 본문, 게시 시각, 공식 원문 링크와 앱 내부 관측·분류·급상승 신호를 검색과 순위 제공에 사용합니다.</li>
        </ul>
      ...
      <PolicySection title="5. 이용자의 선택과 권리">
        <p>사용자는 앱에서 데이터 내보내기, 계정 삭제, 저장 취소, 작성자 숨김 해제, 알림 끄기, 분석 동의 철회를 할 수 있습니다. 추가적인 열람·정정·삭제 문의는 지원 연락처로 요청할 수 있습니다.</p>
      </PolicySection>
