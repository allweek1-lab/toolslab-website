...
export default function MergeGuide() {
  return <main id="main-content" className={`au-wrap ${styles.guide}`}>
    ...
    <section className={styles.contact}><h2>지금 쓰는 양식으로 만들고 싶다면</h2><p>반복 작업 1개, 입력 양식 1종·출력 보고서 1종 기준으로 <strong>19만원부터</strong> 상담합니다. 실제 총금액, 세금 처리와 납기는 자료 확인 후 견적서에서 확정합니다.</p><p>개인정보를 가상 값으로 바꾼 입력 샘플, 원하는 결과 예시, 처리 주기와 대략적인 파일 수를 준비해 주세요. 제작 범위와 수정 조건을 먼저 확인할 수 있습니다.</p><Link className="au-button au-primary" href="/automation#contact">내 업무로 제작 상담</Link><Link className={styles.scopeLink} href="/automation#pricing">가격과 포함 범위 확인</Link></section>
  </main>;
}
